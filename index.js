...
const db = new sqlite3.Database('./solved-problems.db', (err) => {
  if (err) {
...
const data = await solve(decimals.problems[3]);
insertData(db, data);
